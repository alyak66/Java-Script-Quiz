...
var loadScores = function () {
    ...
    //the above sort function sorts the array in ascending order, since I want the score in decending order I am looping through the array in reverse
...
//return the user to index.html when the go back button is pressed
var goBack = function () {
    window.location.href = "./index.html";
}

//clear the localStorage and reloads the scores page to display the no scores message
